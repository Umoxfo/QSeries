...
#		me["alt.1"].setText(sprintf("%s", int(100*math.mod(alt1/100,1))));
#		me["alt.1.top"].setText(sprintf("%s", int(100*math.mod(alt1/100,1))+1));
#		me["alt.1.btm"].setText(sprintf("%s", int(100*math.mod(alt1/100,1))-1));
...
setlistener("sim/signals/fdm-initialized", func {
	...
	PFD_main = canvas_PFD_main.new(groupPFDmain, "Aircraft/Q400/Models/Instruments/PFD/PFD.svg");
	PFD_avail = canvas_PFD_avail.new(groupPFDavail, "Aircraft/Q400/Models/Instruments/PFD/PFDavail.svg");
