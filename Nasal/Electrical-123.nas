...
var auxbattery_volts = props.globals.getNode("systems/electrical/batt-volts",1);
var mainbattery_volts = props.globals.getNode("systems/electrical/batt-volts",1);
...
init_switches = func() {
    ...
    append(lessential_serv_list,"instrumentation/eadi[0]/serviceable");
    append(lessential_servout_list,"eadi[0]");
    append(lessential_serv_list,"instrumentation/ehsi[0]/serviceable");
    append(lessential_servout_list,"ehsi[0]");
    append(lessential_serv_list,"instrumentation/nav[0]/serviceable");
    append(lessential_servout_list,"nav[0]");
    append(lessential_serv_list,"instrumentation/advsy[0]/serviceable");
    ...
    append(lmain_serv_list,"instrumentation/advsy[1]/serviceable");
    append(lmain_servout_list,"advsy[1]");
